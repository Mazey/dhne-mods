...
1. Navigate to `dice-have-no-eyes/Mods/`, create a folder `customcharacters` and inside, you'll want to place `lovely.toml` which you've downloaded as part of the mod.
2. Head back and open the other folder, `dice_have_no_eyes`. Here you will want to put the other files you downloaded, so you should see `dice_have_no_eyes/Mods/customcharacters/characters` after doing this.
...
3. Place the downloaded file in `dice_have_no_eyes/Mods/customcharacters/characters`.
